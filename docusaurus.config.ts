...
const config: Config = {
  title: 'AtWish Airflow Documentation',
  tagline: 'Dinosaurs are cool',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://airflow.atwish.org',
  ...
  projectName: 'Airflow Documentation AtWish', // Usually your repo name.
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/At-Wish/Doc-Airflow',
          label: 'GitHub',
          position: 'right',
        },
      ],
